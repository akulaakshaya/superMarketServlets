...
public class previewServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		ticketModel tm = new ticketModel(request.getParameter("train_no"), request.getParameter("to"),
				request.getParameter("from"), request.getParameter("train_class"), request.getParameter("date"),
				"" + total);

		// pw.print(singleFare);
		// pw.print(individualFaresFinal);
		// pw.print(total);
		request.setAttribute("ticket", tm);
		request.setAttribute("passengersList", passengers);
		request.setAttribute("individualFar", individualFaresFinal);
